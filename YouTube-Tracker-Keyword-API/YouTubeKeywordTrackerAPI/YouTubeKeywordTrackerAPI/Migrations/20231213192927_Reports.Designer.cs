...
namespace YouTubeKeywordTrackerAPI.Migrations
{
    ...
    [Migration("20231213192927_Reports")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YouTubeKeywordTrackerAPI.Entities.Raport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YouTubeKeywordTrackerAPI.Entities.RaportData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RaportsData");
                });

            modelBuilder.Entity("YouTubeKeywordTrackerAPI.Entities.RaportFiles", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YouTubeKeywordTrackerAPI.Entities.RaportData", b =>
                {
                    b.HasOne("YouTubeKeywordTrackerAPI.Entities.Raport", "Raport")
                        .WithMany("RaportDataList")
            ...
            modelBuilder.Entity("YouTubeKeywordTrackerAPI.Entities.RaportFiles", b =>
                {
                    b.HasOne("YouTubeKeywordTrackerAPI.Entities.Raport", "Raport")
                        .WithOne("RaportFile")
                        .HasForeignKey("YouTubeKeywordTrackerAPI.Entities.RaportFiles", "RaportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("YouTubeKeywordTrackerAPI.Entities.Raport", b =>
                {
                    b.Navigation("RaportDataList");

                    b.Navigation("RaportFile")
                        .IsRequired();
                });
